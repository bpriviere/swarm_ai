...
# run with and without heuristics and check the number of 'failed' expansions 
	...
	for trial, (initial_condition,robot_team_composition) in enumerate(zip(initial_conditions,robot_team_compositions)):
		for policy_dict_a in df_param.attackerPolicyDicts:
			for policy_dict_b in df_param.defenderPolicyDicts:
				...
				# if policy_dict_a != policy_dict_b:
				# 	continue 
...
if __name__ == '__main__':
	...
	print("\nGenerating Plots")
	plotter.plot_exp11_results(sim_results)
	...
	plotter.save_figs("plots/exp11.pdf")
	plotter.open_figs("plots/exp11.pdf")
