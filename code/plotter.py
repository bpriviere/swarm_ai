...
def plot_tree_results(sim_result,title=None): 
	...
	for i in range(num_nodes):
		...
		#	# Tag radius at each time step
		#	ax.add_patch(mpatches.Circle(states[t,i,0:2], sim_result["param"]["robots"][i]["tag_radius"],color=colors[i],alpha=0.2,fill=False))
		#	# Velocity arrows at each time step
